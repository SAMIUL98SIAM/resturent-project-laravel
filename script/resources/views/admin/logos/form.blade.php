...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div><div>{{ isset($logo) ? 'Edit' : 'Create New' }} Logo</div></div>
        </div>
...
<div class="row">
    <div class="col-md-12">
        <form method="POST" action="{{isset($logo)?route('admin.logos.update',$logo->id):route('admin.logos.store')}}" enctype="multipart/form-data">
            @csrf
            @isset($logo)
                @method('PUT')
            @endisset
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <div class="form-group" style="text-align: center;">
                                <img id="showImage" src="{{!empty($logo->image)?url('/uploads/logo_images/'.$logo->image):url('/uploads/no_image.jpg')}}" height="300px" width="300px;" alt="Card image cap"/>
                            </div>
